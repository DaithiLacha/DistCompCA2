...
/**
 * <b>LOGINPROG Server Stub</b>
 * This class was automatically generated by Jrpcgen from the RPC/XDR file "stdin". <br>
 * LOGINPROG: was interface
 */

public abstract class LOGINPROGServer extends JRPCServer {
    ...
    /**
     * Constructor that creates an RPC server which implements the "LOGINPROG" interface.
     *
     * @throws RPCError Thrown if the call fails for any reason.
     */
    public LOGINPROGServer() throws RPCError {
        super(LOGINPROG, LOGINVERS, true);
     ...
     * @throws RPCError Thrown if the call fails for any reason.
     */
    public LOGINPROGServer(int port) throws RPCError {
        super(LOGINPROG, LOGINVERS, true);
     ...
     * @throws RPCError Thrown if the call fails for any reason.
     */
    public LOGINPROGServer(int port, boolean do_tcp, boolean do_udp, boolean do_rpcb) throws RPCError {
        super(LOGINPROG, LOGINVERS, do_rpcb);
     ...
     * @throws RPCError Thrown if the call fails for any reason.
     */
    public LOGINPROGServer(int port, int prog_id, boolean do_tcp, boolean do_udp, boolean do_rpcb) throws RPCError {
        super(prog_id, LOGINVERS, do_rpcb);
    ...
    public abstract String login_1(String arg1, String arg2);
}
