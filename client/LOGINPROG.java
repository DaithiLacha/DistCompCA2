 ...
 * It defines the client interface to a server implementing the "LOGINPROG" interface.
 */
public class LOGINPROG extends JRPCClient {

    /**
     * Program ID of the interface.
     */
    public static final int LOGINPROG = 2357;

    /**
     * Creates and connects an RPC client to a server that implements the "LOGINPROG" interface.
     ...
     * @throws RPCError Thrown if the call fails for any reason.
     */
    public LOGINPROG(InetAddress host, boolean stream) throws RPCError {
        super(host, LOGINPROG, LOGINVERS, stream);
    }
    ...
    public LOGINPROG(InetAddress host, int port, boolean stream) throws RPCError {
        super(host, LOGINPROG, LOGINVERS, port, stream);
    }

    /**
     * Creates an RPC client for a server that implements the "LOGINPROG" interface.
    ...
    public LOGINPROG(ClientGeneric protocol) {
        super(protocol);
    }
     ...
     */
    public static final int LOGINVERS = 1;
     ...
     * @throws java.io.IOException Thrown if the call fails because the socket connection fails.
     * @throws RPCError            Thrown if the call fails for any other reason.
     */
